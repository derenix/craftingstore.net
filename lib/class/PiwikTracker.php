...
class PiwikTracker
{
	 ...
	 * @param bool|string $apiUrl "http://example.org/piwik/" or "http://piwik.example.org/"
	 ...
	 * @param string $scope
	 * @throws Exception
	 * @internal param \Custom $int variable slot ID from 1-5
	 * @internal param \Custom $string variable name
	 * @internal param \Custom $string variable value
	 * @internal param \Custom $string variable scope. Possible values: visit, page
	 */
	 ...
	 * @param bool|string $name (optional) Product name
	 * @param array|bool|string $category (optional) Product category, or array of product categories (up to 5 categories can be specified for a given product)
	 * @param bool|float|int $price (optional) Individual product price (supports integer and decimal prices)
	 * @param bool|int $quantity (optional) Product quantity. If not specified, will default to 1 in the Reports
	 * @throws Exception
	 */
	 ...
	 *
	 * @param bool|string $sku Product SKU being viewed
	 * @param bool|string $name Product Name being viewed
	 * @param array|bool|string $category Category being viewed. On a Product page, this is the product's category.
	 *                                You can also specify an array of up to 5 categories for a given page view.
	 * @param bool|float $price Specify the price at which the item was displayed
	 */
	...
	/**
	 * @see doTrackPageView()
	 * @param bool|string $documentTitle Page view name as it will appear in Piwik reports
	 ...
	 * @see doTrackGoal()
	 * @param int $idGoal Id Goal to record a conversion
	 * @param bool|int $revenue Revenue for this conversion
